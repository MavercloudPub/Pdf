...
namespace Mavercloud.PDF {
    ...
    public static partial class Extensions {
        ...
        public static int Value( this System.Enum instance ) {
            return Mavercloud.PDF.Helpers.Enum.GetValue( instance.GetType(), instance );
        }
        ...
        public static TResult Value<TResult>( this System.Enum instance ) {
            return Mavercloud.PDF.Helpers.Convert.To<TResult>( Value( instance ) );
        }
        ...
        public static string Description( this System.Enum instance ) {
            return Mavercloud.PDF.Helpers.Enum.GetDescription( instance.GetType(), instance );
        }
        ...
        public static string Join<T>( this IEnumerable<T> list, string quotes = "", string separator = "," ) {
            return Mavercloud.PDF.Helpers.String.Join( list, quotes, separator );
        }
