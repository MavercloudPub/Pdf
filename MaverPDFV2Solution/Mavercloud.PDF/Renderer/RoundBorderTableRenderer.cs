...
{
    public class RoundBorderTableRenderer: TableRenderer
    {
        private RoundRectangleStyle roundRectangleStyle;
        public RoundBorderTableRenderer(Table modelElement,
        ...
        {
            return new RoundBorderTableRenderer((Table)modelElement, roundRectangleStyle);
        }
